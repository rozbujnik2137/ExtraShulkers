...
public class ItemBuilder {
    ...
    public ItemBuilder setLore(List<String> lore) {
        ItemMeta im = is.getItemMeta();
        im.setLore(StringUtils.color(lore));
        is.setItemMeta(im);
        return this;
    }

    public ItemBuilder enableItemGlow(){
        this.is.addUnsafeEnchantment(Enchantment.THORNS, 1);
    ...
    public ItemBuilder addLoreLine(String line, int pos) {
        ItemMeta im = is.getItemMeta();
        List<String> lore = new ArrayList<>(im.getLore());
        lore.set(pos, StringUtils.color(line));
        im.setLore(lore);
        is.setItemMeta(im);
        return this;
    }
